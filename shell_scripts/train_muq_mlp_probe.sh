...
for fold in 00 01 02 03; do
    python scripts/train_linear_probe.py \
      ...
      --results-dir results/final_muq_mlp_10s_no_pca/fold_${fold} \
      --head mlp \
      --hidden-dim 256 \
      --dropout 0.5 \
      --epochs 100 \
      ...
      --wandb-run-name final_muq_mlp_10s_fold${fold}
  done

python scripts/summarize_results.py \
    --results-root results/final_muq_mlp_10s_no_pca \
    --folds fold_00 fold_01 fold_02 fold_03 \
    --output results/final_muq_mlp_10s_no_pca/summary.json \
    --markdown-output results/final_muq_mlp_10s_no_pca/summary.md
